...
background_image = pygame.transform.scale(
    pygame.image.load('parrot.jpg').convert(),
    (SCREEN_WIDTH, SCREEN_HEIGHT))

rose_image = pygame.transform.scale(
    pygame.image.load('rose.jpg').convert_alpha(), (200, 200))
rose_rect = rose_image.get_rect(center=(SCREEN_WIDTH // 2,
    SCREEN_HEIGHT // 2 - 30))
...
def game_loop():
    ...
    while running:
        ...
        display_surface.blit(rose_image, rose_rect)
